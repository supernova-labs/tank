...
Run (via Bash, always from `/Users/gyprado/dev/tank`):
    ...
    uv run python evals/ablation/query.py --run-id L1--no_locator--nointro--r3 --no-introspect "<SurrealQL>"
...
Return the record ids of the passages of the article titled 'Quantum leap at Helios Labs', in the order they appear in the article (first to last).
