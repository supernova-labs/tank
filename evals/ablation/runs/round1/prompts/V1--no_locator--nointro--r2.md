...
Run (via Bash, always from `/Users/gyprado/dev/tank`):
    ...
    uv run python evals/ablation/query.py --run-id V1--no_locator--nointro--r2 --no-introspect "<SurrealQL>"
...
Which articles were pulled from publication by the editors (killed stories)? Return their record ids.
