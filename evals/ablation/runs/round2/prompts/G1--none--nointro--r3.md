...
Run (via Bash, always from `/Users/gyprado/dev/tank`):
    ...
    uv run python evals/ablation/query.py --round round2 --run-id G1--none--nointro--r3 --no-introspect "<SurrealQL>"
...
How many articles belong to the 'Science' desk? Return the count.

## Deliverable

Return your structured output with:
- `run_id`: "G1--none--nointro--r3"
