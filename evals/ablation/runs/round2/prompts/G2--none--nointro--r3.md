...
Run (via Bash, always from `/Users/gyprado/dev/tank`):
    ...
    uv run python evals/ablation/query.py --round round2 --run-id G2--none--nointro--r3 --no-introspect "<SurrealQL>"
...
Which topics does the article titled 'Election maps redrawn' cover? Return the topic record ids.

## Deliverable

Return your structured output with:
- `run_id`: "G2--none--nointro--r3"
