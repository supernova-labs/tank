...
Run (via Bash, always from `/Users/gyprado/dev/tank`):
    ...
    uv run python evals/ablation/query.py --round round2 --run-id V1--none--nointro--r3 --no-introspect "<SurrealQL>"
...
Which articles were killed (pulled from publication) by the editors? Return their record ids.

## Deliverable

Return your structured output with:
- `run_id`: "V1--none--nointro--r3"
