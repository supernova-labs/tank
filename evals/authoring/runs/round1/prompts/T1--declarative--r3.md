...
- Write your declaration to exactly this file (module-level variable `ontology`):
  `/Users/gyprado/dev/tank/evals/authoring/runs/round1/submissions/T1--declarative--r3.py`
- Validate it by running (from Bash):
    cd /Users/gyprado/dev/tank-spike && uv run python /Users/gyprado/dev/tank/evals/authoring/judge.py --run-id T1--declarative--r3 --arm declarative --task 1 /Users/gyprado/dev/tank/evals/authoring/runs/round1/submissions/T1--declarative--r3.py
...
Return your structured output with: `run_id` = "T1--declarative--r3", `final_exact` (did your
