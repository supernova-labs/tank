...
- Write your declaration to exactly this file (module-level variable `ontology`):
  `/Users/gyprado/dev/tank/evals/authoring/runs/round1/submissions/T3--declarative--r5.py`
- Validate it by running (from Bash):
    cd /Users/gyprado/dev/tank-spike && uv run python /Users/gyprado/dev/tank/evals/authoring/judge.py --run-id T3--declarative--r5 --arm declarative --task 3 /Users/gyprado/dev/tank/evals/authoring/runs/round1/submissions/T3--declarative--r5.py
...
Return your structured output with: `run_id` = "T3--declarative--r5", `final_exact` (did your
