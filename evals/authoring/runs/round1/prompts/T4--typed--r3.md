...
- Write your declaration to exactly this file (module-level variable `ontology`):
  `/Users/gyprado/dev/tank/evals/authoring/runs/round1/submissions/T4--typed--r3.py`
- Validate it by running (from Bash):
    cd /Users/gyprado/dev/tank-spike && uv run python /Users/gyprado/dev/tank/evals/authoring/judge.py --run-id T4--typed--r3 --arm typed --task 4 /Users/gyprado/dev/tank/evals/authoring/runs/round1/submissions/T4--typed--r3.py
...
Return your structured output with: `run_id` = "T4--typed--r3", `final_exact` (did your
