...
- Write your declaration to exactly this file (module-level variable `ontology`):
  `/Users/gyprado/dev/tank/evals/authoring/runs/round2/submissions/T1--typed--haiku--r2.py`
- Validate it by running (from Bash):
    cd /Users/gyprado/dev/tank-spike && uv run python /Users/gyprado/dev/tank/evals/authoring/judge.py --round round2 --run-id T1--typed--haiku--r2 --arm typed --task 1 /Users/gyprado/dev/tank/evals/authoring/runs/round2/submissions/T1--typed--haiku--r2.py
...
Return your structured output with: `run_id` = "T1--typed--haiku--r2", `final_exact` (did your
