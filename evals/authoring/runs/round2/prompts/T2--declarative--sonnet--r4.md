...
- Write your declaration to exactly this file (module-level variable `ontology`):
  `/Users/gyprado/dev/tank/evals/authoring/runs/round2/submissions/T2--declarative--sonnet--r4.py`
- Validate it by running (from Bash):
    cd /Users/gyprado/dev/tank-spike && uv run python /Users/gyprado/dev/tank/evals/authoring/judge.py --round round2 --run-id T2--declarative--sonnet--r4 --arm declarative --task 2 /Users/gyprado/dev/tank/evals/authoring/runs/round2/submissions/T2--declarative--sonnet--r4.py
