...
- Write your declaration to exactly this file (module-level variable `ontology`):
  `/Users/gyprado/dev/tank/evals/authoring/runs/round2/submissions/T2--typed--sonnet--r1.py`
- Validate it by running (from Bash):
    cd /Users/gyprado/dev/tank-spike && uv run python /Users/gyprado/dev/tank/evals/authoring/judge.py --round round2 --run-id T2--typed--sonnet--r1 --arm typed --task 2 /Users/gyprado/dev/tank/evals/authoring/runs/round2/submissions/T2--typed--sonnet--r1.py
...
Return your structured output with: `run_id` = "T2--typed--sonnet--r1", `final_exact` (did your
