...
- Write your declaration to exactly this file (module-level variable `ontology`):
  `/Users/gyprado/dev/tank/evals/authoring/runs/round2/submissions/T4--typed--sonnet--r3.py`
- Validate it by running (from Bash):
    cd /Users/gyprado/dev/tank-spike && uv run python /Users/gyprado/dev/tank/evals/authoring/judge.py --round round2 --run-id T4--typed--sonnet--r3 --arm typed --task 4 /Users/gyprado/dev/tank/evals/authoring/runs/round2/submissions/T4--typed--sonnet--r3.py
