"""Knowledge base ontology declaration."""
...
ontology = Ontology(
    ...
    relations=[
        Relation("summarizes", "summary", "kb_article", kind="field_link", field="article"),
        Relation("written_by", "kb_article", "author", kind="edge", weight=Weight("share")),
    ],
