...
- Write your declaration to exactly this file (module-level variable `ontology`):
  `/Users/gyprado/dev/tank/evals/authoring/runs/round3/submissions/T1--typed--sonnet--r1.py`
- Validate it by running (from Bash):
    cd /Users/gyprado/dev/tank-spike && uv run python /Users/gyprado/dev/tank/evals/authoring/judge.py --round round3 --run-id T1--typed--sonnet--r1 --arm typed --task 1 /Users/gyprado/dev/tank/evals/authoring/runs/round3/submissions/T1--typed--sonnet--r1.py
