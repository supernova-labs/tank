...
- Write your declaration to exactly this file (module-level variable `ontology`):
  `/Users/gyprado/dev/tank/evals/authoring/runs/round3/submissions/T3--typed--haiku--r1.py`
- Validate it by running (from Bash):
    cd /Users/gyprado/dev/tank-spike && uv run python /Users/gyprado/dev/tank/evals/authoring/judge.py --round round3 --run-id T3--typed--haiku--r1 --arm typed --task 3 /Users/gyprado/dev/tank/evals/authoring/runs/round3/submissions/T3--typed--haiku--r1.py
...
Return your structured output with: `run_id` = "T3--typed--haiku--r1", `final_exact` (did your
