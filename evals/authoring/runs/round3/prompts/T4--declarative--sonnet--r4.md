...
- Write your declaration to exactly this file (module-level variable `ontology`):
  `/Users/gyprado/dev/tank/evals/authoring/runs/round3/submissions/T4--declarative--sonnet--r4.py`
- Validate it by running (from Bash):
    cd /Users/gyprado/dev/tank-spike && uv run python /Users/gyprado/dev/tank/evals/authoring/judge.py --round round3 --run-id T4--declarative--sonnet--r4 --arm declarative --task 4 /Users/gyprado/dev/tank/evals/authoring/runs/round3/submissions/T4--declarative--sonnet--r4.py
...
Return your structured output with: `run_id` = "T4--declarative--sonnet--r4", `final_exact` (did your
