...
- Write your declaration to exactly this file (module-level variable `ontology`):
  `/Users/gyprado/dev/tank/evals/authoring/runs/specwriting/submissions/T1--free--w3--typed.py`
- Then run this command ONCE — it records your submission:
    cd /Users/gyprado/dev/tank-spike && uv run python /Users/gyprado/dev/tank/evals/authoring/judge.py --round specwriting --run-id T1--free--w3--typed --arm typed --task 1 /Users/gyprado/dev/tank/evals/authoring/runs/specwriting/submissions/T1--free--w3--typed.py
