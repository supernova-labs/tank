...
- Write your declaration to exactly this file (module-level variable `ontology`):
  `/Users/gyprado/dev/tank/evals/authoring/runs/specwriting/submissions/T2--template--w2--declarative.py`
- Then run this command ONCE — it records your submission:
    cd /Users/gyprado/dev/tank-spike && uv run python /Users/gyprado/dev/tank/evals/authoring/judge.py --round specwriting --run-id T2--template--w2--declarative --arm declarative --task 2 /Users/gyprado/dev/tank/evals/authoring/runs/specwriting/submissions/T2--template--w2--declarative.py
