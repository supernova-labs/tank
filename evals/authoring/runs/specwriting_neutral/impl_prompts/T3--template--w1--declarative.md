...
Read it from: `/Users/gyprado/dev/tank/evals/authoring/runs/specwriting/briefs/T3--template--w1.md`
...
- Write your declaration to exactly this file (module-level variable `ontology`):
  `/Users/gyprado/dev/tank/evals/authoring/runs/specwriting_neutral/submissions/T3--template--w1--declarative.py`
- Then run this command ONCE — it records your submission:
    cd /Users/gyprado/dev/tank-spike && uv run python /Users/gyprado/dev/tank/evals/authoring/judge.py --round specwriting_neutral --run-id T3--template--w1--declarative --arm declarative --task 3 /Users/gyprado/dev/tank/evals/authoring/runs/specwriting_neutral/submissions/T3--template--w1--declarative.py
  You get ONE submission. Do not submit again, whatever it reports.
- Do not read or modify anything under `evals/authoring/golds/`.

## Deliverable

Return your structured output with `run_id` = "T3--template--w1--declarative", `submitted` = true.
